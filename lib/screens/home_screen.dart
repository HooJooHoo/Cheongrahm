...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> getSharedPreferenceOfLunch() async {
    ...
    prefs.setString(
        "tuesdayLunch",
        await APIService()
            .getLunchJsonFromAPI(GetDayOfWeek().getThisTuesday()));
    prefs.setString(
        "wednesdayLunch",
        await APIService()
            .getLunchJsonFromAPI(GetDayOfWeek().getThisWednesday()));
    prefs.setString(
        "thursdayLunch",
        await APIService()
            .getLunchJsonFromAPI(GetDayOfWeek().getThisThursday()));
  ...
  Future<void> getSharedPreferenceOfDinner() async {
    ...
    prefs.setString(
        "mondayDinner",
        await APIService()
            .getDinnerJsonFromAPI(GetDayOfWeek().getThisMonday()));
    prefs.setString(
        "tuesdayDinner",
        await APIService()
            .getDinnerJsonFromAPI(GetDayOfWeek().getThisTuesday()));
    prefs.setString(
        "wednesdayDinner",
        await APIService()
            .getDinnerJsonFromAPI(GetDayOfWeek().getThisWednesday()));
    prefs.setString(
        "thursdayDinner",
        await APIService()
            .getDinnerJsonFromAPI(GetDayOfWeek().getThisThursday()));
    prefs.setString(
        "fridayDinner",
        await APIService()
            .getDinnerJsonFromAPI(GetDayOfWeek().getThisFriday()));
  }
